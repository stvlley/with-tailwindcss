  ...
  return (
    <div name='contact' className=' w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/5a5684bd-7fac-46f2-937c-64325765e7ed" className='hover:scale-110 duration-500 rounded flex flex-col max-w-[600px] w-full'>
            ...
            <button className='hover:scale-110 duration-500 rounded text-white border-2 hover:bg-green-400 hover:border-green-400 px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
